...
static void prvRecursiveMutexControllingTask( void *pvParameters )__attribute__((noreturn));
static void prvRecursiveMutexBlockingTask( void *pvParameters )__attribute__((noreturn));
static void prvRecursiveMutexPollingTask( void *pvParameters )__attribute__((noreturn));
