 ...
 * @file     fmc.h
 * @version  V3.0
 * @brief    M2354 Series Flash Memory Controller(FMC) driver header file
 *
...
#define FULL_ROMSIZE_SEL (M32(0x4000CFF8) & 0x00000020UL) >> 5   /* Full size APROM selection */
...
#define FMC_LDROM_SIZE          0x4000UL        /*!< LDROM Size (16 Kbytes)      */
