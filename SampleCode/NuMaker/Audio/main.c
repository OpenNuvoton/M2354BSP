...
static __attribute__((aligned(32))) int16_t g_i16sin[96] =
{
...
static uint32_t *g_pu32sin = (uint32_t *)(uint32_t)&g_i16sin[0];
...
static volatile uint32_t g_u32Tmp[8] = {0};
void I2S0_IRQHandler(void)
{
    uint32_t u32I2SIntFlag;
...
void SYS_Init(void)
{
    ...
    /* Set multi-function pins for CODEC_I2C */
