...
static volatile uint8_t g_au8SlvRxData[3];
static volatile uint8_t g_u8DeviceAddr;
static volatile uint8_t g_au8MstTxData[256] = {0};
static volatile uint8_t g_au8MstRxData[256] = {0};
static volatile uint8_t g_u8MstDataLen;
static volatile uint8_t g_u8MstEndFlag = 0;
static volatile int32_t g_u32IsTestOver;
static volatile uint8_t g_u8MstTxSLA;
static volatile uint16_t g_u16SlvDataLen;
...
int32_t main(void)
{
    ...
    */
    ...
    g_au8MstTxData[0] = (uint8_t)((g_u8DeviceAddr << 1) | 0x00);   //1 byte SLV + W
