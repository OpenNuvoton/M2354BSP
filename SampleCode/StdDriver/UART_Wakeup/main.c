...
void UART_DataWakeUp(void)
{
    ...
    /* Set UART data wake-up start bit compensation value.
       ...
       If UART_CLK is selected as HIRC(12MHz) and the HIRC stable time is about 19.75us,
       the data wake-up start bit compensation value can be set as 237. */
    UART1->DWKCOMP = 237;
