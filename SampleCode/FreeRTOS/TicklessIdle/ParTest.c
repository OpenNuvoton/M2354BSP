...
void PowerDownFunction(void)
{
    ...
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM1PM0_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM1PM1_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM1PM2_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM1PM3_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM1PM4_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM1PM5_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM1PM6_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM1PM7_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM2PM0_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC0_SRAM2PM1_Msk, SYS_SRAMPC0_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC1_SRAM2PM2_Msk, SYS_SRAMPC1_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC1_SRAM2PM3_Msk, SYS_SRAMPC1_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC1_SRAM2PM4_Msk, SYS_SRAMPC1_SRAM_RETENTION);
    SYS_SetSSRAMPowerMode(SYS_SRAMPC1_SRAM2PM5_Msk, SYS_SRAMPC1_SRAM_RETENTION);
...
void vParTestInitialise(void)
{
    ...
    /* Output selected clock to CKO, CKO Clock = HCLK / 2^(4 + 1) */
    /* CLKO could be used to monitor MCU power down or not. */
    CLK_EnableCKO(CLK_CLKSEL1_CLKOSEL_HCLK, 4, 0);
