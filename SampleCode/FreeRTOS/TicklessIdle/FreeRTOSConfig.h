...
#define RTC_TIME_HZCNT_Pos              (24)
#define RTC_TIME_HZCNT_Msk              (0x7ful << RTC_TIME_HZCNT_Pos)
#define RTC_CLKFMT_HZCNTEN_Pos          (8)
#define RTC_CLKFMT_HZCNTEN_Msk          (0x1ul << RTC_CLKFMT_HZCNTEN_Pos)
#define RTC_TALM_HZCNT_Pos              (24)
#define RTC_TALM_HZCNT_Msk              (0x7ful << RTC_TALM_HZCNT_Pos)
