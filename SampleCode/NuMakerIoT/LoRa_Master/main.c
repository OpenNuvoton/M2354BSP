 ...
 * @file     main.c
 * @version  V1.00
 * @brief    A simple LoRa master demo for NuMaker board.
 *
...
const uint8_t c_au8MasterMsg[] = "This message was sent from master.";
...
int main( void )
{
    ...
    while(1)
    {
        ...
        case RX:
            ...
            memcpy(s_au8Buffer, c_au8MasterMsg, sizeof(c_au8MasterMsg));
            DelayMs(1);
