 ...
 * @file     main.c
 * @version  V3.00
 * @brief    Show how to continue executing code after wake-up from SPD Power-down mode by VTOR function.
 *
 ...
 * @param       None
 * @return      None
 * @details     The RTC_IRQHandler is default IRQ of RTC, declared in mystartup_M2354.s.
 */
void RTC_IRQHandler(void)
{
