...
/**
  * @brief      Perform NuBL2 to verify NuBL32 or NuBL33 F/W in specific Flash bank
  * @param[in]  mode        bit-0: 0:verify NuBL32; 1:verify NuBL33 \n
  *                         bit-4: 0:Integrity check; 1:Identify check
  * @retval     0           Success
  * @retval     others      Failed
  * @details    This function is used to perform identify, authenticate and verify F/W integrity of NuBL32 or NuBL33 in specific Flash bank. \n
  *             Flow: \n
  ...
  */
int32_t NuBL2_ExecuteVerifyNuBL3xBankx(uint32_t *buf, int32_t mode, uint32_t u32BankIdx)
{
    ...
    if(!((mode == 0) || (mode == 1) || (mode == 0x010) || (mode == 0x011) || \
            (mode == 0x100) || (mode == 0x101) || (mode == 0x110) || (mode == 0x111)))
    {
