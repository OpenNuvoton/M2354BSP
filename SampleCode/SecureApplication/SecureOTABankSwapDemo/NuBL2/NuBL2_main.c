 ...
 * @file     NuBL2_main.c
 * @version  V1.00
 * @brief    Demonstrate to do secure OTA update for NuBL32 and NuBL33 firmware by NuBL2 with bank swap.
 *
 * @note
...
int8_t FlashBankSwapCheck(void);
__NONSECURE_ENTRY
...
/**
  * @brief      Check and to do bank swap or not
  * @param      None
  * @retval     0       don't need bank swap
  * @retval     1       do bank swap
  * @details    Check NuBL32/NuBL33 then decide to do bank swap or not.
  */
int8_t FlashBankSwapCheck(void)
{
...
_FAIL:
    printf("FlashBankSwapCheck fail!\n");
    while(1) {}
}
