 ...
 * @file     FwInfo.c
 * @version  V1.00
 * @brief    NuBL32 FW Info template and provided by NuBL2 developer.
 *
...
const uint32_t g_InitialFWInfo[] =
{
    ...
    0x0000000C, 0x20251213, 0x00001111, 0x22223333, // Word-5/6/7: 0x20251213/0x00001111/0x22223333, Extend Info
